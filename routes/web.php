...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('company-transactions/{id}/print-driver-invoice', [CompanyTransactionController::class, 'printDriverInvoice'])->name('company-transactions.print-driver-invoice');
