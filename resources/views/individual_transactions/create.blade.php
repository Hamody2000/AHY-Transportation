...
<div class="container">
    ...
    <form action="{{ route('individual_transactions.store') }}" method="POST">
        @csrf
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input type="number" class="form-control" id="agreed_days_with_vehicle" name="agreed_days_with_vehicle" required>
            </div>
            <div class="form-group col-md-3">
                <label for="agreed_days_with_client">عدد الأيام المتفق عليها مع العميل</label>
                <input type="number" class="form-control" id="agreed_days_with_client" name="agreed_days_with_client" required>
            </div>

            <div class="form-group col-md-3">
                <label for="overnight_price_with_vehicle">سعر المبيت مع السيارة</label>
                <input type="number" class="form-control" id="overnight_price_with_vehicle" name="overnight_price_with_vehicle" required>
            </div>
            <div class="form-group col-md-3">
                <label for="overnight_price_with_client">سعر المبيت مع العميل</label>
                <input type="number" class="form-control" id="overnight_price_with_client" name="overnight_price_with_client" required>
            </div>
        </div>
        <div class="form-row">
            <div class="col-md-6">
